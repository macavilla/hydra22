...
.rotate( 0, () => ( a.fft[2] *.000125 - .72 ) )
.diff(
  shape(6, .6 , 0).rotate(11)
  .rotate( 0, () => ( a.fft[2] *.000125 - .6 ) )
)
.diff(
  shape(6, .5 , 0).rotate(11)
  .rotate( 0, () => ( a.fft[2] *.000125 - .5 ) )
)
.diff(
  shape(6, .22 , 0).rotate(11)
  .rotate( 0, () => ( a.fft[2] *.000125 - .22 ) )
  .diff(
    shape(6, .2 , 0).rotate(11)
    .rotate( 0, () => ( a.fft[2] *.000125 - .2 ) )
  )
  .diff(
    shape(6, .17 , 0).rotate(11)
    .rotate( 0, () => ( a.fft[2] *.000125 - .17 ) )
  )
  .diff(
    shape(6, .12 , 0).rotate(11)
    .rotate( 0, () => ( a.fft[2] *.000125 - .12 ) )
  )
